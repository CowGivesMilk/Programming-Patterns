...
- **They make it harder to reason about code.**
		It is easier to reason about pure functions. When global state arrive changing it can create domino effect through out the code base. It is aldo harder to track bugs.
